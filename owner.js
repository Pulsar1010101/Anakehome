export const ownerData = {
    ...
    interests: [
        ...
        { label: "불호 요소", value: "가족관, 친척관, 애정관, 사랑없는 약혼 등 페어로 엮일 수 있는 모든 관계" }
    ],
    ...
    communication: [
        ...
        { label: "불호 교류", value: "티알피지, 짓시, 디코, FF14, 커마게임 전부 불호" },
        { label: "기념일", value: "안챙김" },
        { label: "언급 빈도", value: "생각날 때마다" }
    ],
    ...
    contact: [
        ...
        { label: "G-18", value: "소재바이소재, 공개 장소 언급은 쿠션 깔기 선호" }
    ],
